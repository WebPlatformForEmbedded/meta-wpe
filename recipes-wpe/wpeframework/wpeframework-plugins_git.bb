...
SRC_URI = "git://git@github.com/WebPlatformForEmbedded/WPEFrameworkPlugins.git;protocol=ssh;branch=master \
          ...
          file://index.html"
SRCREV = "846a2025bf0e193e182325cb12d07978fff7dd29"
...
PACKAGECONFIG ?= "commander ${WPE_COMPOSITOR} deviceinfo locationsync monitor remote remote-uinput ${WPE_SNAPSHOT} tracing virtualinput webkitbrowser webserver youtube ${WPE_TVCONTROL}"
