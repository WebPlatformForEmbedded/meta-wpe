...
PACKAGECONFIG ?= " \
    ...
    deviceinfo dictionary displayinfo locationsync monitor remote remote-devinput securityagent spark streamer timesync tracing ux virtualinput webkitbrowser webserver youtube \
"
