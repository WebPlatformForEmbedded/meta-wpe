...
wget -q https://github.com/Metrological/buildroot-wpe/raw/master/package/opencdm/opencdm.mk
wget -q https://github.com/Metrological/buildroot-wpe/raw/master/package/opencdmi/opencdmi.mk
