...
DEPENDS = "zlib cppsdk wpe"

PV = "1.0+gitr${SRCPV}"

SRC_URI = "git://git@github.com/Metrological/webbridge.git;protocol=ssh"

SRCREV = "92ca7b8682b83e02941394b05a670fef92a9f08b"
...
PACKAGECONFIG[provisioning]       = "-DWEBBRIDGE_PLUGIN_PROVISIONING=ON,-DWEBBRIDGE_PLUGIN_PROVISIONING=OFF,dxdrm,dxdrm"
