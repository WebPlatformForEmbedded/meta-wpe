...
CXXFLAGS_append_rpi = "${@bb.utils.contains('MACHINE_FEATURES', 'vc4graphics', 'null', ' -DWESTEROS_PLATFORM_RPI -DWESTEROS_INVERTED_Y -DBUILD_WAYLAND -I${STAGING_INCDIR}/interface/vmcs_host/linux', d)}"
CXXFLAGS_remove_rpi = "${@bb.utils.contains("MACHINE_FEATURES", "vc4graphics", "-DWESTEROS_PLATFORM_RPI -DWESTEROS_INVERTED_Y -I${STAGING_INCDIR}/interface/vmcs_host/linux", "", d)}"
