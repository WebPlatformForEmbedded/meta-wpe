...
SRC_URI += "file://0001_make_graphic_libs_configurable.patch"
...
GLES2_LIB_NAME  ?= "${@bb.utils.contains('PREFERRED_PROVIDER_virtual/libgles2', 'broadcom-refsw', 'libv3ddriver.so', 'libGLESv2.so.2', d)}"
